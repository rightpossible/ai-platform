...
export default function EnhancedAddAppPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Error creating app: ${error.message || 'Unknown error'}`);
      }
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Create a comprehensive application with rich catalog information</p>
      </div>
