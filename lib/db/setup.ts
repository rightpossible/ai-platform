...
async function getMongoDBURI(): Promise<string> {
  console.log('Step 2: Setting up MongoDB');
  ...
  if (dbChoice.toLowerCase() === 'l') {
    ...
    return 'mongodb://localhost:27017/next_saas_starter';
  } else {
    console.log(
      'You can find MongoDB databases at: https://www.mongodb.com/cloud/atlas or https://vercel.com/marketplace?category=databases'
    );
...
services:
  mongodb:
    ...
    environment:
      MONGO_INITDB_DATABASE: next_saas_starter
    ports:
      - "27017:27017"
    volumes:
